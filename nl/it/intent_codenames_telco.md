...
| Aggiungere un'assicurazione | #Service_Management-Add_Insurance |
| Aggiungi funzioni del servizio | #Service_Management-Add_Service_Features |
| Aiuto | #Help-Help |
...
| Attiva roaming | #Service_Management-Activate_Roaming |
| Attivazione del dispositivo | #Device_Management-Activation |
| Bollette online | #Billing-Online_Statements |
| Cambio del dispositivo | #Device_Management-Swap_Device |
| Cambio del piano tariffario | #Service_Management-Price_Plan_Change |
...
| Disattiva roaming | #Service_Management-De_Activate_Roaming |
| Domanda sul piano tariffario internazionale | #Service_Management-International_Rate_Plan_Inquiry |
| Domanda sul roaming | #Service_Management-Roaming_Inquiry |
| Domande di sicurezza del profilo | #Account_Management-Profile_Security_Questions |
| Domande sul piano tariffario | #Service_Management-Price_Plan_Inquiry |
| Domande sulla copertura di rete | #Service_Management-Coverage_Area_Inquiry |
...
| Fissa un appuntamento al negozio | #Information-Make_Store_Appointment |
...
| Sposta un appuntamento presso il negozio | #Information-Change_Store_Appointment |
...
| Stato di idoneità per gli aggiornamenti. | #Account_Management-Upgrade_Eligibility_Status |
| Tempistiche dell'idoneità per l'aggiornamento | #Account_Management-Upgrade_Eligibility_Timing |
