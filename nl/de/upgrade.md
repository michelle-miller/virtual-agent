...
1. Klicken Sie auf der Seite des {{site.data.keyword.watson}} {{site.data.keyword.virtualagentshort}} unter [{{site.data.keyword.IBM_notm}} Markt ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://www.ibm.com/marketplace/cloud/cognitive-customer-engagement/){: new_window} auf **Preise anzeigen und kaufen**.
...
1. Klicken Sie bei der Kachel des gewünschten Plans auf **Jetzt kaufen**.
1. Passen Sie Ihr Abonnement an und klicken Sie anschließend auf **Weiter zum Auschecken**.
1. Wenn Sie über ein Testabonnement verfügen und ein Upgrade auf einen Standardplan durchführen, können Sie sämtliche Konfigurationsarbeiten aufbewahren, die an der Testinstanz durchgeführt wurden, indem Sie **Test umwandeln** auswählen. Klicken Sie andernfalls auf **Neues Abonnement beziehen**, um mit einer neuen Instanz ganz von vorne zu beginnen.
