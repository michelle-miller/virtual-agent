...
{{site.data.keyword.virtualagentfull}} is a set of preconfigured cognitive components based on the {{site.data.keyword.IBM_notm}} {{site.data.keyword.watson}} {{site.data.keyword.conversationshort}} service. By configuring the virtual agent with your company's information, you can quickly implement an automated chat bot that converses with your customers to help them achieve their goals.
{: shortdesc}
